...
result_table <- data.frame(
  Metric = c("Mean Total Steps Per Day", "Median Total Steps Per Day"),
...
```{r echo=FALSE}
paste("The maximum interval is:", max_interval)
```
...
print(paste("Number of raw observations with no step data - before replacement:", naCount))
```
...
```{r echo=FALSE}
naCount <- sum(is.na(dfData$steps))
print(paste("Number of raw observations with no step data - after replacement:", naCount))
```
...
```{r echo=FALSE}
print(paste("Interval and Observation for Element #45 in the raw data is", rawData$interval[45], "and", rawData$steps[45]))

print(paste("The calculated mean for interval", rawData$interval[45], "is",meanSteps_df$MeanSteps[meanSteps_df$Interval == rawData$interval[45]]))

print(paste("And the imputed value in the data set for interval", rawData$interval[45], "is now", dfData$steps[45]))
```
